...
export const links = {
    ...
    appStore: ()=>{
        window.open('https://apps.apple.com/us/app/livo-app/id1436232095?l=pt&ls=1', '_blank')
    },
    googlePlay: ()=>{
        window.open('https://play.google.com/store/apps/details?id=com.livoapp&hl=en_IN&gl=US', '_blank')
    },
}
